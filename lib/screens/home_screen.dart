...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadProjectList() async {
    ...
    setState(() {
      _savedProjects = keys.map((k) => k.replaceFirst('project_', '')).toList();
    });
  }
          ...
          ? Center(
              child: Column(
                ...
                children: [
                  ...
                  const Text('No projects yet. Start creating!', style: TextStyle(fontSize: 16, color: Colors.grey)),
                ],
              ),
            )
          : ListView.builder(
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    leading: const CircleAvatar(
                      ...
                      child: Icon(Icons.movie_creation, color: Colors.white, size: 20),
                    ),
